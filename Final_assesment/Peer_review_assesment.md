...
This my solution for peer review assignment with [Yelp Open Dataset](https://www.yelp.com/dataset) for Coursera class: SQL for Data Science

Below you can see ER diagram of Yelp Dataset
